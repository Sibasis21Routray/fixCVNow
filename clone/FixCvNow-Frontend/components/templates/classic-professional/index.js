...
// ─────────────────────────────────────────────
export function ClassicProfessionalTemplate({ data, getBlurClass }) {
        ...
        {data.summary && (
          <div className={getBlurClass('light')}>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h2 className="text-sm font-bold" style={{ color: T.color.textPrimary }}>Profile Summary</h2>
            </div>
      ...
      {data.summary && (
        <div className="mb-2">
          <div className="flex items-center gap-1 mb-0.5">
            ...
            <span className="font-bold text-[7px]" style={{ color: T.color.textPrimary }}>Profile Summary</span>
          </div>
